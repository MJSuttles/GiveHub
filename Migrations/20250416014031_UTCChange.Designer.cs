...
namespace GiveHub.Migrations
{
    ...
    [Migration("20250416014031_UTCChange")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiveHub.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactName = "Alice Johnson",
                            ContactPhone = "555-123-4567",
                            Date = new DateTime(2025, 8, 10, 10, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            ContactName = "Brian Meadows",
                            ContactPhone = "555-765-4321",
                            Date = new DateTime(2025, 4, 22, 9, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            ContactName = "David Chen",
                            ContactPhone = "555-321-7890",
                            Date = new DateTime(2025, 6, 12, 15, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            ContactName = "Erika Martinez",
                            ContactPhone = "555-456-9999",
                            Date = new DateTime(2025, 7, 3, 11, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("GiveHub.Models.Tag", b =>
                {
                    b.HasOne("GiveHub.Models.Charity", null)
                        .WithMany("Tags")
                        .HasForeignKey("CharityId");
                });
