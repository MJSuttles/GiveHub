    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Springfield", "alice@hopeforall.org", "Alice Johnson", "555-123-4567", new DateTime(2025, 5, 15, 13, 30, 0, 0, DateTimeKind.Utc), "Providing school supplies to children in need.", "https://example.com/images/schooldrive.jpg", "Back-to-School Drive", "IL", "123 Unity Lane", "uid-hope1", "62704" },
                    { 2, 2, "Boulder", "brian@greenearth.org", "Brian Meadows", "555-765-4321", new DateTime(2025, 5, 15, 13, 30, 0, 0, DateTimeKind.Utc), "Community tree planting initiative.", "https://example.com/images/trees.jpg", "Tree Planting Day", "CO", "45 Nature Ave", "uid-earth2", "80301" },
                    { 3, 3, "Portland", "catherine@foodforward.org", "Catherine Lee", "555-789-0000", new DateTime(2025, 5, 15, 13, 30, 0, 0, DateTimeKind.Utc), "Volunteers needed for distributing donated food.", "https://example.com/images/food.jpg", "Food Distribution Weekend", "OR", "88 Kindness Blvd", "uid-food3", "97201" },
                    { 4, 4, "Austin", "david@booksforkids.org", "David Chen", "555-321-7890", new DateTime(2025, 5, 15, 13, 30, 0, 0, DateTimeKind.Utc), "Raising funds by reading books for donations.", "https://example.com/images/readathon.jpg", "Read-a-Thon Fundraiser", "TX", "212 Literacy Ln", "uid-books4", "73301" },
                    { 5, 5, "Phoenix", "erika@safehaven.org", "Erika Martinez", "555-456-9999", new DateTime(2025, 5, 15, 13, 30, 0, 0, DateTimeKind.Utc), "Connecting homeless individuals with resources.", "https://example.com/images/outreach.jpg", "Homeless Outreach Day", "AZ", "678 Hope St", "uid-safe5", "85001" }
                });
